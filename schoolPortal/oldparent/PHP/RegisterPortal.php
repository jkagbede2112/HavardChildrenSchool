...
if ($counter > 0) {
    ...
    if ($goodSave) {
        ...
        Thank you for taking the time out to register on Havard Children School Parent Portal. Your registration is successful. Kindly click the button below to verify your email and complete your registeration. You will need to enter additional information as required later.
        <br/><br/><br/>
...
<b>Regards</b>,<br/>
            Havard Children School<br/>
            <a href = "http://www.uberit.org" target="_blank">uberSchool</a>
            <br/><br/>';
        ...
        echo "This email may already have been registered. Contact school administrator for assistance.";
    }
}
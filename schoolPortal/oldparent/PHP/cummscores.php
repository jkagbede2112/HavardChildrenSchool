...
function gettotalpossiblescoresgff($stdclass, $resulttype) {
    global $w;
...
function gettotalscoresgff($stdid, $term, $session, $resulttype) {
    global $w;
    if ($resulttype === "midterm") {
...
if ($action === "getcumm") {
    ...
    $totalscorespossible = gettotalpossiblescoresg($stdclass, $resulttype);

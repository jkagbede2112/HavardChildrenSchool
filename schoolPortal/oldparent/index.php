    ...
    <body>
        ...
        <div class="col-lg-12" style="padding:20px 0px 10px 0px; background-image: url('../images/background.jpg'); height:50px">
            <div class="container-fluid menuItem">
                ...
                <span class="pportal" id="suportal" onclick="showwhatPage('#registerportal','#suportal')">Sign Up</span>
            </div>
            <script>
            function showwhatPage(a,b){
              $("#loginportal").hide();
              $("#registerportal").hide();
        ...
        <div class="container" style="">
            <div class="col-lg-12" style="background-color:rgba(255,255,255,0.2); margin-top:50px; margin-bottom:50px; min-height:300px; border-bottom-left-radius: 10px; border-bottom-right-radius:10px; padding:30px">
                <div class="col-lg-6" style="font-size:17px">
                    <div style="font-size:40px; font-weight:300; color:#fff; font-family:raleway">Welcome</div><br/>
                    <div>Accessing your currently enrolled student's information is as easy as 1-2-3</div>
                    <div style="line-height:190% ">
                        <ol>
                            <li>Sign Up for a Parent Portal account. Your user name will be emailed to you after sign-up is complete.</li>
                            <li>Once logged in, click the link to "Pre-register a new student"</li>
                            <li>Follow the on-screen instructions for the pre-registration process</li>
                        </ol>
                    </div>
                </div>
                <div class="col-lg-6" style="background-color:rgba(255,255,255,0.4); padding:20px; border-radius:4px">
                    <div class="form-group" style="margin-top:20px; display:block" id="loginportal">
                        <div style="font-family:verdana;margin-top:20px; margin-bottom:20px; font-size:20px; font-weight:200; color:#003955">Login</div>
                    ...
                    <div class="form-group" style="margin-top:20px; display:none" id="registerportal">
                        ...
                        <label>Password</label>
                        <input type="password" class="form-control" placeholder="Password" id="passwordsu"><br/>

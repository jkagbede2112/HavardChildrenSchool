...
if ($action === "reception") {
    ...
    $comments .= "<tr class='tcmnt'><td style='font-weight:bold; padding:5px'>Teacher's comment : <input value='$teachercommentq' style='width:400px; border-style:none' placeholder='Teacher comment here'  onblur='teacherscomment(\"$teacherid\",\"$resulttype\",\"$session\",\"$term\",\"$stdid\",this.value)'></td></tr>";
    $comments .= "<tr class='tcmnt'><td style=' padding:5px' colspan='5'><b>Proprietress' comment :</b><input type='text' value='$proprietresscomment' style='width:600px; border-style:none' placeholder='Proprietress comment here' onblur='proprietresscomment(\"$session\",\"$term\",\"$stdid\",this.value)'></td></tr></table><div style='margin-top:10px' colspan='5'><div style='margin-top:60px'><span style='display:inline-block; text-align:center'>   <span style='position:relative'><span style='position:absolute; bottom:5px; left:-20px'><img src='$teachersignature' width='150px' height='50px'></span>_________________________</span><br>Class Teacher's Signature</span><span style='margin-left:60px; display:inline-block; position:relative'><span style='position:absolute; bottom:20px; left:20px'><img src='$madamsignature' width='150px' height='50px'></span>_________________________<br>Proprietress's Signature</span></div>";
    echo $comments;
}
...
if ($action === "nursery1") {
    ...
    $comments .= "<tr class='tcmnt'><td style='font-weight:bold; padding:5px'>Teacher's comment :  <input value='$teachercomments' type='text' style='width:400px; border-style:none' placeholder='Teacher comment' onblur='teacherscomment(\"$teacherid\",\"$resulttype\",\"$session\",\"$term\",\"$stdid\",this.value)'></td></tr>";
    $comments .= "<tr class='tcmnt'><td style=' padding:5px' colspan='5'><b>Proprietress' comment :</b> <input type='text' value='$proprietresscomment' style='width:600px; border-style:none' placeholder='Proprietress comment here' onblur='proprietresscomment(\"$session\",\"$term\",\"$stdid\",this.value)'> </td></tr></table><div style='margin-top:10px' colspan='5'><div style='margin-top:60px'><span style='display:inline-block; text-align:center'>   <span style='position:relative'><span style='position:absolute; bottom:5px; left:-20px'><img src='$teachersignature' width='150px' height='50px'></span>_________________________</span><br>Class Teacher's Signature</span><span style='margin-left:60px; display:inline-block; position:relative'><span style='position:absolute; bottom:20px; left:20px'><img src='$madamsignature' width='150px' height='50px'></span>_________________________<br>Proprietress's Signature</span></div>";
    echo $comments;
}
...
$average = ($firsttermscore + $totalwexam)/2;
                ...
                if ($term === "3rd Term"){
                    ...
                    $prep .= "<tr style='font-size:13px; font-family:verdana; text-align:center; font-size:12px'><td style='width:20px;padding:5px'>$cnt</td><td style='text-align:left'>&nbsp;  $subjectname</td><td style='width:60px'>$code</td><td style='width:60px'>$total</td><td style='text-align:center'><input id='cron$supval$cnt' type='text' size='3' value='$exam' onblur=\"saveresultnurt('$classid', '$session', '$term', '$stdid', '$subjectid','cron$supval$cnt','exam')\"></td><td style=''>$totalwexam</td><td>$mgrade</td><td>$firsttermscore</td><td>$secondterm</td><td>$totalwexam</td><td>$averagescore</td><td>$highestscore</td><td>$lowestscore</td><td>$haveraged</td></tr>";
                }
            /*
    ...
    //Get all comments
    {
        ...
        $comments .= "<tr class='tcmnt'><td style=' padding:5px' colspan='5'><b>Teacher's comment :</b> <input value='$teachercomment' style='width:400px'  onblur='teacherscomment(\"$teacherid\",\"$resulttype\",\"$session\",\"$term\",\"$stdid\",this.value)'></td></tr>";
...
if ($action === "nursery2mid") {
        ...
        while ($q = mysqli_fetch_array($gt)) {
            ...
            //fillrez = fillrez($studentid, $subjectid, $term, $session, $classid, $result);
            {
                $prep .= "<tr style='font-size:13px; font-family:verdana; text-align:center; font-size:12px'><td style='width:20px;padding:5px'>$cnt</td><td style='text-align:left'>&nbsp;  $subjectname</td><td style='width:60px'>$code</td><td style='width:60px'>"
                        . "<center><input type='text' size='2' value='$firstca' id='cron$add$supval$cnt' class='fcr form-control' onblur=\"saveresultnurt('$classid', '$session', '$term', '$stdid', '$subjectid','cron$add$supval$cnt','first')\"></center>"
                        . "</td><td style=''>"
                        . "<center><input type='text' size='2' value='$secondca' class='form-control fcr' id='crtw$add$supval$cnt' onblur=\"saveresultnurt('$classid', '$session', '$term', '$stdid', '$subjectid','crtw$add$supval$cnt','second')\"></center>"
                        . "</td><td>"
                        . "<center><input type='text' size='2' value='$thirdca' class='form-control fcr' id='crth$add$supval$cnt' onblur=\"saveresultnurt('$classid', '$session', '$term', '$stdid', '$subjectid','crth$add$supval$cnt','third')\"></center>"
    ...
    //Get all comments
    {
        ...
        $teachersignature = getteachersignature($classid);
        $comments = "<div style='margin-top:20px'></div><table style='width:100%; margin-top:10px; font-size:12px'><tr><td></td><td></td><td></td><td></td></tr>";
        $comments .= "<tr class='tcmnt'><td style='font-weight:bold; padding:5px' colspan='5'>Teacher's comment : <input value='$teachercommentx' style='width:400px'  onblur='teacherscomment(\"$teacherid\",\"$resulttype\",\"$session\",\"$term\",\"$stdid\",this.value)'></td></tr>";
        $comments .= "<tr class='tcmnt'><td style=' padding:5px' colspan='5'><b>Proprietress' comment :</b> $proprietresscomment </td></tr></table><div style='margin-top:10px' colspan='5'><div style='margin-top:60px'><span style='display:inline-block; text-align:center'>   <span style='position:relative'><span style='position:absolute; bottom:5px; left:-20px'><img src='$teachersignature' width='150px' height='50px'></span>_________________________</span><br>Class Teacher's Signature</span><span style='margin-left:60px; display:inline-block; position:relative'><span style='position:absolute; bottom:20px; left:20px'><img src='$madamsignature' width='150px' height='50px'></span>_________________________<br>Proprietress's Signature</span></div>";
        echo $comments;
    }
}
...
//If result is midterm
    if ($resulttype === "midterm") {
        ...
        //Get all comments
        {
            ...
            $teachersignature = getteachersignature($classid);
            $comments = "<div style='margin-top:20px'></div><table style='width:100%; margin-top:10px; font-size:12px'><tr><td></td><td></td><td></td><td></td></tr>";
            $comments .= "<tr class='tcmnt'><td style='font-weight:bold; padding:5px' colspan='5'>Teacher's comment :  <input value='$teachercommenty' style='width:400px'  onblur='teacherscomment(\"$teacherid\",\"$resulttype\",\"$session\",\"$term\",\"$stdid\",this.value)'></td></tr>";
            $comments .= "<tr class='tcmnt'><td style=' padding:5px' colspan='5'><b>Proprietress' comment :</b> $proprietresscomment </td></tr></table><div style='margin-top:10px' colspan='5'><div style='margin-top:60px'><span style='display:inline-block; text-align:center'>   <span style='position:relative'><span style='position:absolute; bottom:5px; left:-20px'><img src='$teachersignature' width='150px' height='50px'></span>_________________________</span><br>Class Teacher's Signature</span><span style='margin-left:60px; display:inline-block; position:relative'><span style='position:absolute; bottom:20px; left:20px'><img src='$madamsignature' width='150px' height='50px'></span>_________________________<br>Proprietress's Signature</span></div>";
            echo $comments;
        }
    }

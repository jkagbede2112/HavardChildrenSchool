...
if (mysqli_num_rows($sdfk)<1){
    echo "<tr style='padding:20px'><td colspan='11' style='color:#ff0000; font-family:raleway; text-align:center; font-size:16px'>Could not find payment history for <b>".$searchval."</b> for <b>".$sess."</b> session in <b>".$term."</b></td></tr>";
}
/*

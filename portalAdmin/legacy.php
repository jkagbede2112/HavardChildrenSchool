    ...
    function resnurttypechange(a){
        ...
        if (a==="midterm"){
            ...
            $("#nurtfullterm").show();
                                    ...
                                    <script>
                                    function savereportcard(a, b, c, d, e, f){
                                        var reportcard = document.getElementById(a).innerHTML;
                                        var classid = document.getElementById(b).value;
                                        var studentid = document.getElementById(d).value;
                                        var sess = document.getElementById(e).value;
                                        var term = document.getElementById(f).value;
                                        try {
                                            var restype = document.getElementById(c).value;
                                        }catch(err){
                                            var restype = "";
                                        }
                                        

                                        var action = "saveoldrecord";
                                        //alert(reportcard);
//alert("classid " + classid + " -resultype " + restype + " -Stdid " + studentid + " -sess " + sess + " -term "+ term);
                                        $.post("PHP/savereportcard.php",{action:action, reportcard:reportcard, classid:classid, restype:restype, stdid:studentid, sess:sess, term:term}).done(function(data){
                                            alert(data);
                                ...
                                <div style="font-family:raleway; font-size:30px; margin-bottom:20px">
                                    ...
                                    <div class="col-md-12" style="padding:0px; font-size:12px">
                                        ...
                                        <div class="col-md-4" style="background-color:rgba(255,255,255,0.1); padding:10px">
                                            ...
                                            <select class="form-control" style="margin-bottom:10px" id="resgradertor">
                                            <option>--Select--</option>
                                                <option value="midterm">Mid-Term Result</option>
                                                <option value="terminal">Terminal Result</option>
                                            </select>
                                            <label>Class</label>
                                            <select class="form-control" style="margin-bottom:10px" id="resgradecor" onchange="pulloldstds()">
                                                <option>--Select--</option>
                                                <?php
                                                $j = mysqli_query($w, "select * from schclass order by ClassName asc");
                                            ...
                                            <label>Session</label>
                                            <select class="form-control" id="resgradesor" onchange="pulloldstds()">
                                                    <?php
                                                    $year = date("Y")+1;
                                                    $yearlast = $year - 1;
                                                    $a = 5;
                                            ...
                                            <span class="col-md-6" style="padding:0px">
                                                <label>Term</label>
                                                <select id="resgadetor" class="form-control" style="margin-bottom:10px" onchange="pulloldstds()">
                                            ...
                                            <select class="form-control" id="gdschidor"></select>
                                            <!--<input type='textbox' class='form-control' style='margin-bottom:10px' placeholder='e.g PG6352' id=''>-->
                                            <input value="Get report" style="margin-top:10px" class="btn btn-success" onclick="getresgradeord()" type="button">
                                        </div>
                                        <script>
                                        function pulloldstds(){
                                            var sess = document.getElementById("resgradesor").value;
                                            var term = document.getElementById("resgadetor").value;
                                            var classid = document.getElementById("resgradecor").value;
                                            var action = "getoldstds";
                                            $.post("PHP/getreportcard.php",{action:action, sess:sess, term:term, classid:classid}).done(function(data){
                                                //alert(data);
                                                document.getElementById("gdschidor").innerHTML = data;
                                            });
                                        }
                                        </script>
                                        <div class="col-md-8" style="background-color:rgba(255,255,255,0.1); padding:5px; text-align:center">
                                            <div style="text-align:left; text-align:center">
                                                <span style="cursor:pointer; padding:5px;" class="btn btn-danger" onclick="printDiv('gradResltold')"><i class="fa fa-book"></i> - Print report</span>
                                            </div>
                                            <center>
                                                <div style="padding:5px;" id="gradResltold">No reports found</div>
                                            </center>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class='row' style='margin:0px;' id="home">
                            ...
                            <div class='col-md-2' style='background-color:rgba(255,255,255,0.2); border-radius:2px; margin-bottom:20px; padding:0px;'>
                                <table class="table table-responsive table-hover" style="font-size:12px">
                                    ...
                                    <tr class="point"><td >Pupil Count</td><td style="background-color:#C5D9E2;font-weight:bold; text-align:center" id="sc">0</td></tr>
                                    ...
                                    <tr class="point"><td >Pre-registered Pupil</td><td style="background-color:#C5D9E2;font-weight:bold; text-align:center" id="prs">0</td></tr>
                                </table>
                            </div>
                        ...
                        <div class='row' style='margin:0px; display:none' id="parents">
                            ...
                            <div style='margin-bottom:30px; font-size:25px; text-align:center'>HAVARD CHILDREN SCHOOLS<br>PARENTS</div>
                            ...
                            <div class="modal fade bs-example-modal-md" id="updateStudent" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" style='font-family:verdana; font-size:12px'>
                                <div class="modal-dialog modal-md" role="document" style='font-face:verdana; font-size:12px'>
                                    <div class="modal-content">
                                        <div class="modal-header" style='background-color:#E8EEF4'>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                            <h6><center><b>Update Pupil Information<br/><span id='teachername' style="font-weight:normal"></span></b></center></h6>
                                        </div>
                                        <script>
...
<div id='stdhealthstatus' class='addtinfo'></div>
                            ...
                            <div style="font-family:raleway; font-size:30px; margin-bottom:20px">
                                <span id="studentcount"></span> Pupil
                            </div>
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content" style="background-color:#D0E0E8">
                                        <div style="padding:20px; padding-top:20px; margin-bottom:10px; border-radius:2px; background-color:rgba(255,255,255,0.2); position:relative" id="msgtab">
                                            ...
                                            <label style="margin-top:15px">Pupil group</label>

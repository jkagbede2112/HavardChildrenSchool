...
$staffID = "AGIC" . rand(1000, 9999);
$staffemail = $_POST['email'];
$staffPassword = "Amazing". rand(250, 999). chr(rand(45,66));

$hsf = "insert into schstaff (StaffID, StaffName, StaffEmail, StaffPhone, StaffCredentials, StaffAddress, StaffPassword) "
        . "values('$staffID','$staffname','$staffemail','$staffphone','$staffcredential','$staffaddress','$staffPassword')";

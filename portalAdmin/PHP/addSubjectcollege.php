...
$s = "insert into subjects_college (SubjectID,SubjectName, subjectcode,SubjectCategoryid,Compulsory,Subjectgroup) values ('$subjectID','$subject','$subcode','$class','$status','$subjectcat')";
//echo $s;
$a = mysqli_query($w, $s);
if ($a) {
    echo "Subject added";

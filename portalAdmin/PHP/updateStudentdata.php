...
$sender = mysqli_query($w,"update schstudent set Surname='$sname', Middlename='$mname', Firstname='$fname', ClassID='$classID', HomeAddress='$address', EmailAddress='$stdemail' where StudentID='$id'");
if ($sender){
    echo "Update sent";
}else{
